...
// Données des services avec slugs définis
const servicesData = [
  {
...
// Fonction pour nettoyer complètement et recréer
const resetServices = async () => {
  try {
    console.log('🗑️ Clearing existing services collection...');
    
    // Supprimer tous les documents
    await Service.deleteMany({});
    
    // Supprimer tous les index (pour résoudre les conflits)
    try {
    ...
    console.log('🌱 Creating fresh services...');
